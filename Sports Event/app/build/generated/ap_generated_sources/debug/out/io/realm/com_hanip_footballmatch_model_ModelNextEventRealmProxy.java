...
public class com_hanip_footballmatch_model_ModelNextEventRealmProxy extends com.hanip.footballmatch.model.ModelNextEvent
    implements RealmObjectProxy, com_hanip_footballmatch_model_ModelNextEventRealmProxyInterface {

    static final class ModelNextEventColumnInfo extends ColumnInfo {
        long IdEventIndex;
        long EventIndex;
        long FileNameIndex;
        long VenueIndex;
        ...
        ModelNextEventColumnInfo(OsSchemaInfo schemaInfo) {
            super(6);
            OsObjectSchemaInfo objectSchemaInfo = schemaInfo.getObjectSchemaInfo("ModelNextEvent");
        ...
        ModelNextEventColumnInfo(ColumnInfo src, boolean mutable) {
            super(src, mutable);
            copy(src, this);
        }
        ...
        protected final ColumnInfo copy(boolean mutable) {
            return new ModelNextEventColumnInfo(this, mutable);
        }

        @Override
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            final ModelNextEventColumnInfo src = (ModelNextEventColumnInfo) rawSrc;
            final ModelNextEventColumnInfo dst = (ModelNextEventColumnInfo) rawDst;
    ...
    private ModelNextEventColumnInfo columnInfo;
    private ProxyState<com.hanip.footballmatch.model.ModelNextEvent> proxyState;

    com_hanip_footballmatch_model_ModelNextEventRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.columnInfo = (ModelNextEventColumnInfo) context.getColumnInfo();
        this.proxyState = new ProxyState<com.hanip.footballmatch.model.ModelNextEvent>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("ModelNextEvent", 6, 0);
    ...
    public static ModelNextEventColumnInfo createColumnInfo(OsSchemaInfo schemaInfo) {
        return new ModelNextEventColumnInfo(schemaInfo);
    }

    public static String getSimpleClassName() {
        return "ModelNextEvent";
    }

    public static final class ClassNameHelper {
        public static final String INTERNAL_CLASS_NAME = "ModelNextEvent";
    }

    @SuppressWarnings("cast")
    public static com.hanip.footballmatch.model.ModelNextEvent createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.hanip.footballmatch.model.ModelNextEvent obj = realm.createObjectInternal(com.hanip.footballmatch.model.ModelNextEvent.class, true, excludeFields);

        final com_hanip_footballmatch_model_ModelNextEventRealmProxyInterface objProxy = (com_hanip_footballmatch_model_ModelNextEventRealmProxyInterface) obj;
        if (json.has("IdEvent")) {
    ...
    public static com.hanip.footballmatch.model.ModelNextEvent createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.hanip.footballmatch.model.ModelNextEvent obj = new com.hanip.footballmatch.model.ModelNextEvent();
        final com_hanip_footballmatch_model_ModelNextEventRealmProxyInterface objProxy = (com_hanip_footballmatch_model_ModelNextEventRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.hanip.footballmatch.model.ModelNextEvent copyOrUpdate(Realm realm, com.hanip.footballmatch.model.ModelNextEvent object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.hanip.footballmatch.model.ModelNextEvent) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.hanip.footballmatch.model.ModelNextEvent copy(Realm realm, com.hanip.footballmatch.model.ModelNextEvent newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.hanip.footballmatch.model.ModelNextEvent realmObject = realm.createObjectInternal(com.hanip.footballmatch.model.ModelNextEvent.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_hanip_footballmatch_model_ModelNextEventRealmProxyInterface realmObjectSource = (com_hanip_footballmatch_model_ModelNextEventRealmProxyInterface) newObject;
        com_hanip_footballmatch_model_ModelNextEventRealmProxyInterface realmObjectCopy = (com_hanip_footballmatch_model_ModelNextEventRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.hanip.footballmatch.model.ModelNextEvent object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.hanip.footballmatch.model.ModelNextEvent.class);
        long tableNativePtr = table.getNativePtr();
        ModelNextEventColumnInfo columnInfo = (ModelNextEventColumnInfo) realm.getSchema().getColumnInfo(com.hanip.footballmatch.model.ModelNextEvent.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        Table.nativeSetLong(tableNativePtr, columnInfo.IdEventIndex, rowIndex, ((com_hanip_footballmatch_model_ModelNextEventRealmProxyInterface) object).realmGet$IdEvent(), false);
        String realmGet$Event = ((com_hanip_footballmatch_model_ModelNextEventRealmProxyInterface) object).realmGet$Event();
        if (realmGet$Event != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.EventIndex, rowIndex, realmGet$Event, false);
        }
        String realmGet$FileName = ((com_hanip_footballmatch_model_ModelNextEventRealmProxyInterface) object).realmGet$FileName();
        if (realmGet$FileName != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.FileNameIndex, rowIndex, realmGet$FileName, false);
        }
        String realmGet$Venue = ((com_hanip_footballmatch_model_ModelNextEventRealmProxyInterface) object).realmGet$Venue();
        if (realmGet$Venue != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.VenueIndex, rowIndex, realmGet$Venue, false);
        }
        String realmGet$Thumb = ((com_hanip_footballmatch_model_ModelNextEventRealmProxyInterface) object).realmGet$Thumb();
        if (realmGet$Thumb != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.ThumbIndex, rowIndex, realmGet$Thumb, false);
        }
        String realmGet$Country = ((com_hanip_footballmatch_model_ModelNextEventRealmProxyInterface) object).realmGet$Country();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        ModelNextEventColumnInfo columnInfo = (ModelNextEventColumnInfo) realm.getSchema().getColumnInfo(com.hanip.footballmatch.model.ModelNextEvent.class);
        com.hanip.footballmatch.model.ModelNextEvent object = null;
        while (objects.hasNext()) {
            object = (com.hanip.footballmatch.model.ModelNextEvent) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.hanip.footballmatch.model.ModelNextEvent object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.hanip.footballmatch.model.ModelNextEvent.class);
    ...
    public static com.hanip.footballmatch.model.ModelNextEvent createDetachedCopy(com.hanip.footballmatch.model.ModelNextEvent realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.hanip.footballmatch.model.ModelNextEvent unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.hanip.footballmatch.model.ModelNextEvent();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.hanip.footballmatch.model.ModelNextEvent) cachedObject.object;
            }
            unmanagedObject = (com.hanip.footballmatch.model.ModelNextEvent) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_hanip_footballmatch_model_ModelNextEventRealmProxyInterface unmanagedCopy = (com_hanip_footballmatch_model_ModelNextEventRealmProxyInterface) unmanagedObject;
        com_hanip_footballmatch_model_ModelNextEventRealmProxyInterface realmSource = (com_hanip_footballmatch_model_ModelNextEventRealmProxyInterface) realmObject;
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("ModelNextEvent = proxy[");
    ...
    public boolean equals(Object o) {
        ...
        com_hanip_footballmatch_model_ModelNextEventRealmProxy aModelNextEvent = (com_hanip_footballmatch_model_ModelNextEventRealmProxy)o;

        String path = proxyState.getRealm$realm().getPath();
        String otherPath = aModelNextEvent.proxyState.getRealm$realm().getPath();
        if (path != null ? !path.equals(otherPath) : otherPath != null) return false;

        String tableName = proxyState.getRow$realm().getTable().getName();
        String otherTableName = aModelNextEvent.proxyState.getRow$realm().getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (proxyState.getRow$realm().getIndex() != aModelNextEvent.proxyState.getRow$realm().getIndex()) return false;
